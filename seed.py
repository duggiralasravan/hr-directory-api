...
engine = create_engine("sqlite:///./shards/shard_1.db", connect_args={"check_same_thread": False})
...
employees = [
    ...
    Employee(id=3, name="Carol", status="Not Started", location="Boston", company="TechCorp", department="HR", position="Recruiter", organization_id=1),
    ...
    Employee(id=6, name="Carl Case", status="Not Started", location="Boston", company="TechCorp", department="HR",
             position="Recruiter", organization_id=1)
    ,
]
